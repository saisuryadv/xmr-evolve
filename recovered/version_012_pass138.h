...
inline void postprocess_tgk_svd(int n, const double* d, const double* e,
    ...
    if (n <= 80) {
        ...
        for (int j = 0; j < n; j++) {
            ...
            // Recover when one side is notably worse (10x ratio)
            if (res_u > 10.0 * base_thresh && res_u > 10.0 * (res_v + SAFMIN)) {
            ...
            } else if (res_v > 10.0 * base_thresh && res_v > 10.0 * (res_u + SAFMIN)) {
